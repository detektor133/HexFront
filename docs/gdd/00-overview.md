...
| Армия (отряд) | `Army` | Однотипный отряд с числом солдат |
| Тип войск | `UnitType` | `infantry`, `armor`, `artillery` |
| Организованность | `org` | 0–100, «боевой дух»; при 0 армия отступает |
| Снабжённость | `supplyLevel` | 0–100 % для армии |
| Фронт | `Front` | Граница с конкретным врагом |
| Котёл | — | Армии без снабжения, без пути отступления |
| Ополчение | `militia` | Пассивная оборона города без армии |
