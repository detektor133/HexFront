...
| T11. HUD и карточка по `ui.md` | готово | По замечаниям владельца 2026-09-25: верхняя полоса (люди и золото с приростом, налог с ползунком и подсказкой итога, снабжение, время, место по очкам), карточка снизу слева только с доступными действиями, прогресс строек (строка, полоса, дуга на карте), дороги пунктиром по дереву связей без треугольников, изолированные — серые; знак города — круг-метка (выбор владельца), размер — доля гекса по уровню, растёт при приближении |
...
- `stage-02/economy-1440x900-zoom.png` — масштаб 1,8, нейтральный город (только информация), раскрыт ползунок налога с подсказкой.
...
✔ no dependency violations found (127 modules, 368 dependencies cruised)
tokens: up to date
